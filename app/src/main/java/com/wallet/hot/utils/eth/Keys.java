...
import com.wallet.hot.utils.eth.ECKeyPair;
import org.web3j.crypto.Hash;
import org.web3j.utils.Numeric;
import org.web3j.utils.Strings;

import static com.wallet.hot.utils.eth.SecureRandomUtils.secureRandom;
...
public class Keys {
    ...
    public static org.web3j.crypto.ECKeyPair createEcKeyPair() throws InvalidAlgorithmParameterException,
            NoSuchAlgorithmException, NoSuchProviderException {
        KeyPair keyPair = createSecp256k1KeyPair();
        return org.web3j.crypto.ECKeyPair.create(keyPair);
    }
    ...
    public static byte[] serialize(org.web3j.crypto.ECKeyPair ecKeyPair) {
