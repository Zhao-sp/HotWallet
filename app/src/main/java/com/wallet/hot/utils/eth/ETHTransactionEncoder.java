...
public class ETHTransactionEncoder {
    ...
    public static byte[] signMessage(RawTransaction rawTransaction, ETHCredentials credentials) {
    ...
    public static byte[] signMessage(
            RawTransaction rawTransaction, byte chainId, ETHCredentials credentials) {
