...
public class MyListView extends ListView implements OnScrollListener {
	...
	public void onScrollStateChanged(AbsListView arg0, int arg1) {
		if(Data.gettype().equals("zxactivity")) {
			if (arg1 == SCROLL_STATE_FLING || arg1 == SCROLL_STATE_IDLE) {
	...
	private void changeHeaderViewByState() {
		switch (state) {
			case RELEASE_To_REFRESH:
				...
				tipsTextview.setText(R.string.head3);
			...
			case PULL_To_REFRESH:
				...
				if (isBack) {
					...
					tipsTextview.setText(R.string.head1);
				} else {
					tipsTextview.setText(R.string.head1);
				}
				Log.v(TAG, "当前状态，下拉刷新");
			...
			case REFRESHING:
				...
				tipsTextview.setText(R.string.head4);
				lastUpdatedTextView.setVisibility(View.VISIBLE);
	...
	public void onRefreshComplete() {
		state = DONE;
		lastUpdatedTextView.setText(Data.getcontext().getResources().getString(R.string.head5) + new Date().toLocaleString());
		changeHeaderViewByState();
	}
