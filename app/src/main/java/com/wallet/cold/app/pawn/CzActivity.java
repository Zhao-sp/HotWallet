...
public class CzActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyAdapter(CzActivity.this, list);
        lv1.setAdapter(adapter);
        fhgx=(TextView) findViewById(R.id.fhgx);fhgx.setOnClickListener(this);
        Data.settype("czactivity");
        Data.setcontext(CzActivity.this);
                ...
                viewHolder.submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (money1.length() < 1) {
                            ...
                            final EditText inputServer = new EditText(CzActivity.this);
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(CzActivity.this);
